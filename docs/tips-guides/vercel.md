...
The easiest way to get started with **Iris OS** is to deploy it directly to Vercel.
...
6. **Update API Keys and Settings (optional).**
   ...
   - Example environment file: [example.env](https://github.com/dwickyfp/iris-os/blob/main/.env.example)
