...
export const ActivityEventPayloadRegistry = {
  ...
  "goal.created": RunPayloadSchema,
  "goal.revised": RunPayloadSchema,
  "goal.round_requested": RunPayloadSchema,
  "goal.round_started": RunPayloadSchema,
  "goal.round_completed": RunPayloadSchema,
  "goal.verification_failed": RunPayloadSchema,
  "goal.blocked": RunPayloadSchema,
  "goal.completed": RunPayloadSchema,
  "goal.exhausted": RunPayloadSchema,
  "strategy.stalled": RunPayloadSchema,
  "strategy.corrected": RunPayloadSchema,
  "inbox.followup_received": RunPayloadSchema,
  "inbox.steer_received": RunPayloadSchema,
  "inbox.inject_received": RunPayloadSchema,
  "inbox.item_consumed": RunPayloadSchema,
  "scheduler.batch_started": RunPayloadSchema,
  "scheduler.call_started": RunPayloadSchema,
  "scheduler.call_committed": RunPayloadSchema,
  "result_surface.pruned": RunPayloadSchema,
  "result_surface.referenced": RunPayloadSchema,
  "context.pressure_detected": ContextPreparationPayloadSchema,
  "context.compaction_started": ContextPreparationPayloadSchema,
  "context.compaction_completed": ContextPreparationPayloadSchema,
  "context.retry": ContextPreparationPayloadSchema,
  "composition.started": RunPayloadSchema,
  "composition.completed": RunPayloadSchema,
  "job.queued": RunPayloadSchema,
  "job.started": RunPayloadSchema,
  "job.completed": RunPayloadSchema,
  "job.failed": RunPayloadSchema,
  "job.cancelled": RunPayloadSchema,
