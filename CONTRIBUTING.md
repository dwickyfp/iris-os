# Contributing to Iris OS

Thank you for your interest in contributing to Iris OS! We welcome contributions from the community and truly appreciate your effort to improve the project.
...
2. **Clone your fork** locally:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/iris-os.git
   cd iris-os
   ```
...
We sincerely appreciate your contribution to Iris OS.
